...
int main() {
    ...
    for(l=0;l<40;l++) {
		for(i=0;i<60;i++) {
			for(j=0;j<40;j++) {
				if(l == 6 && i == 31  && j == 6) {fprintf(p,"4 0.0 0.0 0.0 0.0 ");}
				else if(l== 4 && j==4 && i==1) {fprintf(p,"0 90.0 0.0 0.0 0.0 ");} 
                ...
                else if(i== 20 && j == 9 && (l == 32 || l == 36 )) {fprintf(p,"2 90.0 0.0 0.0 0.0 ");}
				...
				else if( i==30 && (j>3 && j<9) && (l<37 && l>7) && (l%2 == 0 && j%2 ==0))  { 
					if(l == 22) {fprintf(p,"1 270.0 0.0 -1.0 0.0 ");}
					else {fprintf(p,"1 270.0 0.0 0.0 0.0 ");}
				}
